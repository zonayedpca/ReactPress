...
function my_theme_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			...
			'source'             => get_stylesheet_directory() . '/plugins/rest-api.zip', // The plugin source.
			'required'           => true, // If false, the plugin is only 'recommended' instead of required.
			'version'            => '2.0-beta15', // E.g. 1.0.0. If set, the active plugin must be this version or higher. If the plugin version is higher than the plugin version installed, the user will be notified to update the plugin.
        ...
        array(
			'name'               => 'REST API – Filter Fields', // The plugin name.
			'slug'               => 'rest-api-filter-fields', // The plugin slug (typically the folder name).
			'source'             => get_stylesheet_directory() . '/plugins/rest-api-fliter.zip', // The plugin source.
			'required'           => true, // If false, the plugin is only 'recommended' instead of required.
